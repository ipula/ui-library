<template>
	...
	<div v-if="store.invitationPayload.userId !== null">
		<div class="p-1">
			...
			<h4 class="text-sm m-0 leading-6">{{ t('user.givenName') }}</h4>
			<div class="text-sm mb-4 leading-6">
				{{ store.invitationPayload.givenName }}
			</div>
			<h4 class="text-sm m-0 leading-6">{{ t('user.familyName') }}</h4>
			<div class="text-sm mb-4 leading-6">
				{{ store.invitationPayload.familyName }}
			</div>
			<h4 class="text-sm m-0 leading-6">{{ t('user.affiliation') }}</h4>
			<div class="text-sm mb-4 leading-6">
